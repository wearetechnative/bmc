...
- [x] 6.1 Export `PrintTable` in `internal/ui/table.go` for formatted stdout output
- [x] 6.5 Implement `PrintTable` using `lipgloss.NewTable()`: bordered, bold header, columns auto-width
