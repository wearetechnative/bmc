# ec2connect-filter-by-name Specification

## Purpose
Defines the filtering capability for the ec2connect command, allowing users to narrow down the instance list by providing a search fragment as a positional argument.
